...
To report a vulnerability, encrypt your findings with the repository PGP key and email `security@nhbcoin.com`. For urgent issues, escalate via Signal at `+13234559568`.
