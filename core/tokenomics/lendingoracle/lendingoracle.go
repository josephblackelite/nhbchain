...
// verification) and an off-chain signing service can share the exact same
// canonical-message logic instead of it being duplicated by hand in two
// places -- any drift between two hand-duplicated implementations would
// make every signature silently fail verification, or worse, verify
