...
// TxTypeRedeemNHB swap-out request. This is how an off-chain watcher
// discovers burns awaiting an off-chain payout -- see
// core/state/redemption.go's pending-request index and
