...
func writeNetworkUnavailable(w http.ResponseWriter, id any) {
	writeError(w, http.StatusServiceUnavailable, id, codeServerError, "unavailable", "p2p server not running")
}
