...
func file_gov_v1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gov_v1_tx_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_gov_v1_tx_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_gov_v1_tx_proto_msgTypes[8].Exporter = func(v any, i int) any {
