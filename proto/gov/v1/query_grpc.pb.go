...
func (c *queryClient) GetProposal(ctx context.Context, in *GetProposalRequest, opts ...grpc.CallOption) (*GetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetProposal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListProposals(ctx context.Context, in *ListProposalsRequest, opts ...grpc.CallOption) (*ListProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListProposals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTally(ctx context.Context, in *GetTallyRequest, opts ...grpc.CallOption) (*GetTallyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetTally_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
