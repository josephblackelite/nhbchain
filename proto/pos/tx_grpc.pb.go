...
func (c *txClient) AuthorizePayment(ctx context.Context, in *MsgAuthorizePayment, opts ...grpc.CallOption) (*MsgAuthorizePaymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tx_AuthorizePayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txClient) CapturePayment(ctx context.Context, in *MsgCapturePayment, opts ...grpc.CallOption) (*MsgCapturePaymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tx_CapturePayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *txClient) VoidPayment(ctx context.Context, in *MsgVoidPayment, opts ...grpc.CallOption) (*MsgVoidPaymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tx_VoidPayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTxServer must be embedded to have forward compatible implementations.
