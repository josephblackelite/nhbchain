...
function createBaseSupplyAssetRequest(): SupplyAssetRequest {
  return { account: "", market: undefined, amount: "", signedTxJson: "" };
}
...
export const SupplyAssetRequest: MessageFns<SupplyAssetRequest> = {
  encode(message: SupplyAssetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.signedTxJson !== "") {
      writer.uint32(34).string(message.signedTxJson);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.signedTxJson = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SupplyAssetRequest {
    return {
      ...
      signedTxJson: isSet(object.signedTxJson) ? globalThis.String(object.signedTxJson) : "",
    };
  },
  ...
  toJSON(message: SupplyAssetRequest): unknown {
    ...
    if (message.signedTxJson !== "") {
      obj.signedTxJson = message.signedTxJson;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SupplyAssetRequest>): SupplyAssetRequest {
    ...
    message.signedTxJson = object.signedTxJson ?? "";
    return message;
  },
};
...
export const DepositCollateralRequest: MessageFns<DepositCollateralRequest> = {
  ...
  create(base?: DeepPartial<DepositCollateralRequest>): DepositCollateralRequest {
    return DepositCollateralRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DepositCollateralRequest>): DepositCollateralRequest {
    const message = createBaseDepositCollateralRequest();
    message.account = object.account ?? "";
    message.market = (object.market !== undefined && object.market !== null)
      ? MarketKey.fromPartial(object.market)
...
function createBaseDepositCollateralResponse(): DepositCollateralResponse {
  return { txHash: "" };
}

export const DepositCollateralResponse: MessageFns<DepositCollateralResponse> = {
  encode(message: DepositCollateralResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.txHash !== "") {
      writer.uint32(10).string(message.txHash);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DepositCollateralResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDepositCollateralResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DepositCollateralResponse {
    return { txHash: isSet(object.txHash) ? globalThis.String(object.txHash) : "" };
  },

  toJSON(message: DepositCollateralResponse): unknown {
    const obj: any = {};
    if (message.txHash !== "") {
      obj.txHash = message.txHash;
    }
  ...
  create(base?: DeepPartial<DepositCollateralResponse>): DepositCollateralResponse {
    return DepositCollateralResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DepositCollateralResponse>): DepositCollateralResponse {
    const message = createBaseDepositCollateralResponse();
    message.txHash = object.txHash ?? "";
    return message;
  },
...
function createBaseWithdrawCollateralRequest(): WithdrawCollateralRequest {
  return { account: "", market: undefined, amount: "", signedTxJson: "" };
}

export const WithdrawCollateralRequest: MessageFns<WithdrawCollateralRequest> = {
  encode(message: WithdrawCollateralRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.account !== "") {
      writer.uint32(10).string(message.account);
    }
    if (message.market !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WithdrawCollateralRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWithdrawCollateralRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): WithdrawCollateralRequest {
    return {
      account: isSet(object.account) ? globalThis.String(object.account) : "",
      market: isSet(object.market) ? MarketKey.fromJSON(object.market) : undefined,
      amount: isSet(object.amount) ? globalThis.String(object.amount) : "",
  ...
  toJSON(message: WithdrawCollateralRequest): unknown {
    const obj: any = {};
    if (message.account !== "") {
      obj.account = message.account;
    }
  ...
  create(base?: DeepPartial<WithdrawCollateralRequest>): WithdrawCollateralRequest {
    return WithdrawCollateralRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<WithdrawCollateralRequest>): WithdrawCollateralRequest {
    const message = createBaseWithdrawCollateralRequest();
    message.account = object.account ?? "";
    message.market = (object.market !== undefined && object.market !== null)
      ? MarketKey.fromPartial(object.market)
...
function createBaseWithdrawCollateralResponse(): WithdrawCollateralResponse {
  return { txHash: "" };
}

export const WithdrawCollateralResponse: MessageFns<WithdrawCollateralResponse> = {
  encode(message: WithdrawCollateralResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.txHash !== "") {
      writer.uint32(10).string(message.txHash);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WithdrawCollateralResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWithdrawCollateralResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): WithdrawCollateralResponse {
    return { txHash: isSet(object.txHash) ? globalThis.String(object.txHash) : "" };
  },

  toJSON(message: WithdrawCollateralResponse): unknown {
    const obj: any = {};
    if (message.txHash !== "") {
      obj.txHash = message.txHash;
    }
  ...
  create(base?: DeepPartial<WithdrawCollateralResponse>): WithdrawCollateralResponse {
    return WithdrawCollateralResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<WithdrawCollateralResponse>): WithdrawCollateralResponse {
    const message = createBaseWithdrawCollateralResponse();
    message.txHash = object.txHash ?? "";
    return message;
  },
...
function createBaseLiquidateRequest(): LiquidateRequest {
  return { liquidator: "", market: undefined, borrower: "", signedTxJson: "" };
}

export const LiquidateRequest: MessageFns<LiquidateRequest> = {
  encode(message: LiquidateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LiquidateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLiquidateRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LiquidateRequest {
    return {
  ...
  toJSON(message: LiquidateRequest): unknown {
    const obj: any = {};
    if (message.liquidator !== "") {
  ...
  create(base?: DeepPartial<LiquidateRequest>): LiquidateRequest {
    return LiquidateRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<LiquidateRequest>): LiquidateRequest {
    const message = createBaseLiquidateRequest();
...
function createBaseLiquidateResponse(): LiquidateResponse {
  return { txHash: "" };
}

export const LiquidateResponse: MessageFns<LiquidateResponse> = {
  encode(message: LiquidateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.txHash !== "") {
      writer.uint32(10).string(message.txHash);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LiquidateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLiquidateResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LiquidateResponse {
    return { txHash: isSet(object.txHash) ? globalThis.String(object.txHash) : "" };
  },

  toJSON(message: LiquidateResponse): unknown {
    const obj: any = {};
    if (message.txHash !== "") {
      obj.txHash = message.txHash;
    }
  ...
  create(base?: DeepPartial<LiquidateResponse>): LiquidateResponse {
    return LiquidateResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<LiquidateResponse>): LiquidateResponse {
    const message = createBaseLiquidateResponse();
    message.txHash = object.txHash ?? "";
    return message;
  },
...
export const LendingServiceService = {
  ...
  depositCollateral: {
    path: "/lending.v1.LendingService/DepositCollateral",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DepositCollateralRequest): Buffer =>
      Buffer.from(DepositCollateralRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DepositCollateralRequest => DepositCollateralRequest.decode(value),
    responseSerialize: (value: DepositCollateralResponse): Buffer =>
      Buffer.from(DepositCollateralResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DepositCollateralResponse => DepositCollateralResponse.decode(value),
  },
  withdrawCollateral: {
    path: "/lending.v1.LendingService/WithdrawCollateral",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: WithdrawCollateralRequest): Buffer =>
      Buffer.from(WithdrawCollateralRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): WithdrawCollateralRequest => WithdrawCollateralRequest.decode(value),
    responseSerialize: (value: WithdrawCollateralResponse): Buffer =>
      Buffer.from(WithdrawCollateralResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): WithdrawCollateralResponse => WithdrawCollateralResponse.decode(value),
  },
  liquidate: {
    path: "/lending.v1.LendingService/Liquidate",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: LiquidateRequest): Buffer => Buffer.from(LiquidateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): LiquidateRequest => LiquidateRequest.decode(value),
    responseSerialize: (value: LiquidateResponse): Buffer => Buffer.from(LiquidateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): LiquidateResponse => LiquidateResponse.decode(value),
  },
} as const;
...
export interface LendingServiceServer extends UntypedServiceImplementation {
  ...
  depositCollateral: handleUnaryCall<DepositCollateralRequest, DepositCollateralResponse>;
  withdrawCollateral: handleUnaryCall<WithdrawCollateralRequest, WithdrawCollateralResponse>;
  liquidate: handleUnaryCall<LiquidateRequest, LiquidateResponse>;
}
...
export interface LendingServiceClient extends Client {
  ...
  depositCollateral(
    ...
    callback: (error: ServiceError | null, response: DepositCollateralResponse) => void,
  ): ClientUnaryCall;
  depositCollateral(
    request: DepositCollateralRequest,
    metadata: Metadata,
  ...
  withdrawCollateral(
    ...
    callback: (error: ServiceError | null, response: WithdrawCollateralResponse) => void,
  ): ClientUnaryCall;
  withdrawCollateral(
    request: WithdrawCollateralRequest,
    metadata: Metadata,
  ...
  liquidate(
    ...
    callback: (error: ServiceError | null, response: LiquidateResponse) => void,
  ): ClientUnaryCall;
  liquidate(
    request: LiquidateRequest,
    metadata: Metadata,
