...
* **Mint-side reconciliation:** `payments-gateway` now exposes `GET /invoices`, `GET /reconciliation/summary`, and
  `GET /reconciliation/export` for invoice-to-mint reporting. See [payments-reconciliation.md](/C:/Users/Mba1/Documents/Nwudu/nhbchain/docs/api/payments-reconciliation.md).
